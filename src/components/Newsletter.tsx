...
export function Newsletter() {
  ...
  return (
    <section aria-labelledby="news" className="border-t border-white/10 bg-ember text-ink">
      <div className="max-w-[1440px] mx-auto px-[clamp(18px,4vw,56px)] py-[clamp(48px,7vw,100px)] grid gap-[clamp(22px,4vw,60px)] items-center [grid-template-columns:repeat(auto-fit,minmax(300px,1fr))]">
        <div>
